...
# FUNCTIONS RELATED TO WORKING WITH DNA AND RNA


def run_dna_rna_tools(seqs: List[str], procedure: str) -> List[str]:
    """
    run_dna_rna_tools(seqs:List[str], procedure:str)
    seqs: list of DNA or RNA sequences
...
# FUNCTIONS RELATED TO WORKING WITH PROTEINS

def protein_analysis(seqs: List[str], procedure: str, cell_type: str = None,
    ...
    Arguments:
    - list of strings with amino acid sequences
    ...
    """
    amino_acid_seqs = name_transform(seqs, letter_format)
    procedures = {
...
def molecular_weight(amino_acid_seqs: List[str]) -> List[float]:
    """
...
def one_letter_to_three(amino_acid_seqs: List[str]) -> List[str]:
    """
    ...
    Return:
    - List of strings with three-letter coded sequences
    """
    three_letters_seqs = []
    for seq in amino_acid_seqs:
        three_letters_seq = []
...
def get_amino_acid_sum(protein_sequences: List[str]) -> List[str]:
    """
...
def codon_optimization(protein_sequences: List[str], cell_type: str) \
        -> List[str]:
    """
...
def length(seqs: List[str]) -> List[int]:
    """
...
def name_transform(seqs: List[str], letter_format: int) -> List[str]:
    """
...
def brutto_count(seqs: List[str]) -> List[str]:
    """
